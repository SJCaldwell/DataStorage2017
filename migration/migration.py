import flask
from flask import render_template, request, flash, session, url_for, redirect, jsonify, Response
import json
...
class Athlete_lifts(db.Model):
	...
	def serialize(self):
		return {'lift_id' : self.lift_id,
				...
				'weightclass_kg' : self.weightclass_kg,
...
def get_all_lifts():
	...
	with open('athlete_lifts.json', 'w') as outfile:
